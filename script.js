...
let fruits1 = ["pear", "apple", "peach", "plum", "strawberry"];
console.log("Uppgift 1:", fruits1);

// -----------------------------------------------------------------------------------------------------
/* 2 */
/* Gör en array som innehåller 3 olika datatyper, ex. string, number, array. */
let mixedArray = ["cat", -24, [677, 18, 1]];
console.log("Uppgift 2:", mixedArray);
...
let animals = ["cat", "hamster", "parrot", "funky chihuahua"];
console.log("Uppgift 3:", animals.length);
...
console.log("Uppgift 5:", animals[3]);
...
// let shallowCopy = arr
// let testAlterOriginal = shallowCopy.pop()
// console.log('original array', arr) //the shallowCopy altered the original array
let arrClone = [...arr];
// arrClone.pop()
// console.log('original array', arr); //the deep copy did not alter the original array
console.log("Uppgift 9", arrClone);
...
console.log("Uppgift 10", [...fruits, "cherry"]);

// -----------------------------------------------------------------------------------------------------
/* 11 */
/* let fruits = ['kiwi', 'apple', 'pear']; */
/* Lägg till en frukt i början av arrayen ovan. */
console.log("Uppgift 11", ["cherry", ...fruits]);
...
let sorted = persons.sort((a, b) => a.name.localeCompare(b.name));

// behind the scenes happenning:
// let sorted = persons.sort((x, y) => {
//   if (x.name < y.name) {
//     return -1;
//   }
//   if (x.name > y.name) {
